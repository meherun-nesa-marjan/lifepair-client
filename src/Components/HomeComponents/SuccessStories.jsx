...
const SuccessStories = () => {
    ...
    return (
        <div className="w-11/12 mx-auto my-10 px-4 py-10 dark:bg-gray-900 dark:text-white bg-pink-50 rounded-lg shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {successStories.map((story) => {
                    ...
                    return (
                        <div key={_id} className="bg-white dark:bg-gray-900 dark:text-white dark:border-2 shadow-md rounded-lg p-4">
                            <div className="flex flex-col items-center space-y-4">
                                ...
                                />
                                {/* Marriage Date */}
                                <p className="text-gray-600 dark:bg-gray-900 dark:text-white text-sm">
                                ...
                                <p className="text-gray-700 text-center dark:bg-gray-900 dark:text-white">{successStoryReview}</p>
                            </div>
                        </div>
                    );
                })}
